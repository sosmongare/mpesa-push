...
if(isset($_POST['submit'])){
  ...
  # access token
  $consumerKey = 'TRDbtQo8jagvDgBITn2asX3txStgUylm'; //Fill with your app Consumer Key(abel)replace with theirs
  $consumerSecret = 'OidFuM7lCAxthah6'; // Fill with your app Secret(abel)replace with theirs
  ...
  */
  ...
  $CallBackURL = 'https://alphasolutions.co.ke/simplepay2/callback_url.php';  
